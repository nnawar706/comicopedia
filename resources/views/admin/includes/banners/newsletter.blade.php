<h2 class="accordion-header" id="flush-headingOne">
    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseFour" aria-expanded="false" aria-controls="flush-collapseFour">
        Newsletter Us <span style="margin-left:10px;font-size: 12px; color: #5a5c69">*Dimensions: 336x280</span>
    </button>
</h2>
    ...
    <div class="accordion-body">
        <div class="card card-body">
            <div class="d-flex flex-nowrap">
                @if(count($data[2]['banners']) === 0)
                    <p>No Banner Found</p>
                @else
                    @foreach($data[2]['banners'] as $item)
            ...
            <button type="button" class="btn btn-primary text-center" data-bs-toggle="modal"
                    data-bs-target="#updateNews" data-whatever="@mdo">
                Add New
            </button>
        </div>
    </div>
</div>
<div class="modal fade" id="updateNews" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title" id="exampleModalLabel1">Newsletter</h6>
            </div>
            <div class="modal-body image-body text-center">
                <form action="/admin/banners/3" method="post" enctype="multipart/form-data">
                    @csrf
