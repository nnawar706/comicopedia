            ...
            <div class="col-lg-5 col-md-6">
                <div class="checkout__order">
                    ...
                    <div class="checkout__order__total">Total <span>&#2547; {{ \Illuminate\Support\Facades\Session::get('cart_price')-\Illuminate\Support\Facades\Session::get('promo_discount') }}</span>
                        ...
                        <p style="font-size: 11px;color:#f30000">* &#2547;{{ \Illuminate\Support\Facades\Session::get('promo_discount') }} Discount Applied. Used promo code: <u>{{ \Illuminate\Support\Facades\Session::get('promo') }}</u></span>
                        @endif
                    </p>
